...
const Profile = () => {
    ...
    return (
        <div className="custom-scrollbar pb-10 w-full">
            ...
            group-hover:shadow-[0_0_12px_rgba(234,179,8,0.8)]

            /* Dark mode overrides */
            dark:border-yellow-400/60
            dark:shadow-[0_0_6px_rgba(250,204,21,0.4)]
            dark:group-hover:shadow-[0_0_12px_rgba(250,204,21,0.7)]
        "
                        >
                            <Star
                                size={14}
                ...
                dark:text-yellow-400 dark:fill-yellow-400
            "
                            />
                        </span>
                        ...
                        <span
                            className="
            max-w-0 overflow-hidden whitespace-nowrap text-xs ml-0
            transition-all duration-300 ease-in-out

            /* Light mode text */
            text-yellow-600 
            group-hover:max-w-[100px] group-hover:ml-2
            ...
            >
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel className="mx-auto w-full max-w-2xl rounded-2xl bg-white dark:bg-zinc-900 p-6 shadow-2xl border border-gray-200 dark:border-gray-700 animate-fadeIn">
                        ...
                        <Dialog.Title className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-5">
                            Ratings & Reviews
                        </Dialog.Title>

                        {reviewData && reviewData.length > 0 ? (
                            <div className="gap-4 max-h-[65vh] overflow-y-auto pr-2">
                                {reviewData.map((review: any, index: number) => (
                                    <div
                                        key={index}
